...
function Income( {incomes, showIncome, setShowIncome, incEditPopup, setIncEditPopup, incDeletePopup, setIncDeletePopup, handleIncomeSubmit, incomeDetails, setIncomeDetails, handleIncomeUpdate, handleIncomeDelete} ) {
